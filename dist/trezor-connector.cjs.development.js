        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              tx = new ethereumjsTx.Transaction(txPayload); // Set the EIP155 bits
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return new Promise(function (resolve) { resolve(_interopNamespace(require('trezor-connect'))); }).then(function (m) {
                var _m$default;
